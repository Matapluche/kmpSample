(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'untitled-js-legacy', 'kotlin-test'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('untitled-js-legacy'), require('kotlin-test'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'untitled-js-legacy-test'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'untitled-js-legacy-test'.");
    }
    if (typeof this['untitled-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'untitled-js-legacy-test'. Its dependency 'untitled-js-legacy' was not found. Please, check whether 'untitled-js-legacy' is loaded prior to 'untitled-js-legacy-test'.");
    }
    if (typeof this['kotlin-test'] === 'undefined') {
      throw new Error("Error loading module 'untitled-js-legacy-test'. Its dependency 'kotlin-test' was not found. Please, check whether 'kotlin-test' is loaded prior to 'untitled-js-legacy-test'.");
    }
    root['untitled-js-legacy-test'] = factory(typeof this['untitled-js-legacy-test'] === 'undefined' ? {} : this['untitled-js-legacy-test'], kotlin, this['untitled-js-legacy'], this['kotlin-test']);
  }
}(this, function (_, Kotlin, $module$untitled_js_legacy, $module$kotlin_test) {
  'use strict';
  var base64 = $module$untitled_js_legacy.org.jetbrains.base64;
  ...
  Kotlin.defineModule('untitled-js-legacy-test', _);
  return _;
}));

//# sourceMappingURL=untitled-js-legacy-test.js.map
