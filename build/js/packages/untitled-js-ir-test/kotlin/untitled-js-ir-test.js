(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './untitled-js-ir.js', './kotlin-kotlin-test-js-ir.js', './kotlin-kotlin-stdlib-js-ir.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./untitled-js-ir.js'), require('./kotlin-kotlin-test-js-ir.js'), require('./kotlin-kotlin-stdlib-js-ir.js'));
  else {
    if (typeof this['untitled-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled-js-ir-test'. Its dependency 'untitled-js-ir' was not found. Please, check whether 'untitled-js-ir' is loaded prior to 'untitled-js-ir-test'.");
    }
    if (typeof this['kotlin-kotlin-test-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled-js-ir-test'. Its dependency 'kotlin-kotlin-test-js-ir' was not found. Please, check whether 'kotlin-kotlin-test-js-ir' is loaded prior to 'untitled-js-ir-test'.");
    }
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled-js-ir-test'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'untitled-js-ir-test'.");
    }
    root['untitled-js-ir-test'] = factory(typeof this['untitled-js-ir-test'] === 'undefined' ? {} : this['untitled-js-ir-test'], this['untitled-js-ir'], this['kotlin-kotlin-test-js-ir'], this['kotlin-kotlin-stdlib-js-ir']);
  }
}(this, function (_, kotlin_me_user_untitled, kotlin_kotlin_test, kotlin_kotlin) {
  'use strict';
  //region block: imports
  var Base64Factory_getInstance = kotlin_me_user_untitled.$_$.a;
...
//# sourceMappingURL=untitled-js-ir-test.js.map